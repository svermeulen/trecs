    ...
    public class MalformedCollectionTests
    {
        ...
        public void Collection_TruncatedElementData_ThrowsException()
        {
            ...
            try
            {
                ...
                Assert.Throws<Exception>(() => newCacheHelper.ReadAll<List<string>>());
            }
            finally
            {
        ...
        public void Dictionary_MissingValueData_ThrowsException()
        {
            ...
            try
            {
                ...
                Assert.Throws<Exception>(() => newCacheHelper.ReadAll<Dictionary<int, string>>());
            }
            finally
            {
                newCacheHelper?.Dispose();
        ...
        public void Collection_ZeroCountWithData_HandlesGracefully()
        {
            ...
            using (var reader = new BinaryReader(stream))
            {
                ...
                if (includesTypeChecks)
                {
                    ...
                    Assert.IsEqual(listTypeId, TypeIdProvider.GetTypeId<List<int>>());

                    var intTypeId = reader.ReadInt32();
                    Assert.IsEqual(intTypeId, TypeIdProvider.GetTypeId<int>());
                }
            ...
            try
            {
                ...
                Assert.Throws<Exception>(() => newCacheHelper.ReadAll<List<int>>());
            }
            finally
            {
                newCacheHelper?.Dispose();
