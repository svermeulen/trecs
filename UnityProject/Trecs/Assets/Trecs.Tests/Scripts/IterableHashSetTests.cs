...
{
    [TestFixture]
    public class IterableHashSetTests
    {
        #region Add / Contains
        ...
        {
            var set = new IterableHashSet<int>(32);
        ...
        {
            var set = new IterableHashSet<int>();
        ...
        public void TestEquality()
        {
            ...
            var set = new IterableHashSet<Vector2>();
        ...
        {
            var set1 = new IterableHashSet<int>();
            set1.Add(1);
            set1.Add(2);
            set1.Add(3);

            var set2 = new IterableHashSet<int>();
            set2.Add(3);
            set2.Add(4);
            set2.Add(5);
        ...
        public void TestReadOnlyHashSet()
        {
            ...
            ReadOnlyIterableHashSet<int> readOnlySet = set;
        ...
        {
            var set = new IterableHashSet<int>(100);
