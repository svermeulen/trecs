...
{
    [TestFixture]
    public class ListSerializerUnmanagedTests
    {
        ...
        [Test]
        public void SvList_ShrinkingPayloads_ScratchReuseKeepsExactCount()
        {
            ...
            // list after a larger one must not leak stale trailing scratch
            // elements into the result (guards the AddRange prefix adapter).
            ...
            _helper.WriteAll(_data, bigList, TestConstants.Version, includeTypeChecks: true, 0L);
            var bigResult = _helper.ReadAll<List<int>>(_data);
            TrecsDebugAssert.That(bigResult.Count == 100);

            var smallList = new List<int> { 7, 8, 9 };
            ...
            var smallResult = _helper.ReadAll<List<int>>(smallData);

            TrecsDebugAssert.That(smallResult.Count == 3);
            TrecsDebugAssert.That(smallResult[0] == 7);
            TrecsDebugAssert.That(smallResult[1] == 8);
            TrecsDebugAssert.That(smallResult[2] == 9);
        }
        ...
        public void SvList_WithFloatElements_SerializesAndDeserializes()
        {
            ...
            var deserializedList = _helper.ReadAll<List<float>>(_data);
        ...
        public void SvList_WithVector3Elements_SerializesAndDeserializes()
        {
            ...
            var deserializedList = _helper.ReadAll<List<Vector3>>(_data);
        ...
        public void SvList_WithMathematicsInt2_SerializesAndDeserializes()
        {
            ...
            var deserializedList = _helper.ReadAll<List<int2>>(_data);
        ...
        public void SvList_ByteValues_SerializesAndDeserializes()
        {
            ...
            var deserializedList = _helper.ReadAll<List<byte>>(_data);
        ...
        public void SvList_PreAllocatedEmptyList_DeserializesCorrectly()
        {
            ...
            // Act
            _helper.ReadAll(_data, ref deserializedList);
        ...
        public void SvList_BlitPerformanceTest_CompareWithRegularList()
        {
            ...
            var deserializedBlitList = _helper.ReadAll<List<int>>(_data);
            stopwatch.Stop();
            ...
            var deserializedRegularList = _helper.ReadAll<List<int>>(_data);
            stopwatch.Stop();
            ...
            Debug.Log(
                $"ListSerializerUnmanaged: {blitListTime} ticks, Regular ListSerializerManaged: {regularListTime} ticks. Blit ratio: {(float)blitListTime / regularListTime:F2}x"
            );
        }
    }
}
