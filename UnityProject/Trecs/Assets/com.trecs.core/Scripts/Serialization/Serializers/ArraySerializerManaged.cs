...
namespace Trecs.Serialization
{
    ...
    /// <see cref="ArraySerializerUnmanaged{TElem}"/> instead, which writes the
    /// elements as a single blit and avoids per-element framing.
    /// </summary>
    public sealed class ArraySerializerManaged<TElem> : ISerializer<TElem[]>
        where TElem : class
    {
        public ArraySerializerManaged() { }
