...
namespace Trecs.Serialization
{
    ...
    /// name/type framing that <see cref="ArraySerializerManaged{TElem}"/> incurs.
    /// </summary>
    public sealed class ArraySerializerUnmanaged<TElem> : ISerializer<TElem[]>
        where TElem : unmanaged
    {
        public ArraySerializerUnmanaged() { }
