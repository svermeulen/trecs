...
namespace Trecs.Serialization.Internal
{
    ...
    /// looks up their <see cref="SerializerRegistry"/> via
    /// <see cref="TrecsSerializerRegistries.GetOrCreateDefault"/>.
    ///
    ...
    static class TrecsEditorRecordingAutoAttach
    {
        ...
        {
            Assert.That(_activationCount > 0, "Deactivate without matching Activate");
            _activationCount--;
        ...
        static void AttachForWorld(World world)
        {
            ...
            var registry = TrecsSerializerRegistries.GetOrCreateDefault(world);
