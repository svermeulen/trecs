...
namespace Trecs.Serialization.Samples.Pointers
{
    ...
    /// because the managed <see cref="TrailHistory"/> payload needs a custom
    /// <see cref="Trecs.Serialization.ISerializer{T}"/> implementation to
    /// survive snapshot save / load via the Trecs Player window — see
    ...
    public class PointersCompositionRoot : CompositionRootBase
    {
        ...
        )
        {
            ...
            serializerRegistry.RegisterSerializer<TrailHistorySerializer>();
