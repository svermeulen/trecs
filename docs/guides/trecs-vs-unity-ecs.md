...
| **Phase / group structure** | System groups (`InitializationSystemGroup`, etc.) | [Five fixed phases](../core/systems.md#phase-diagram) — EarlyPresentation, Input, Fixed, Presentation, LatePresentation |
